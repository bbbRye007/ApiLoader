...
public class VehicleInspectionFileLoader: EndpointLoaderBase
{

    [SetsRequiredMembers]
    public VehicleInspectionFileLoader(IVendorAdapter vendorAdapter, BlobContainerClient containerClient, string environmentName, int maxDegreeOfParallelism, int maxRetries, int minRetryDelayMs) 
    ...
    {
        var endpoint = new VehicleInspectionFileEndpoint(VendorAdapter, EnvironmentName, MaxDegreeOfParallelism, MaxRetries, MinRetryDelayMs);
        InitRun(endpoint);
