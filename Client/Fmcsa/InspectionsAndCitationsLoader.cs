...
public class InspectionsAndCitationsLoader: EndpointLoaderBase
{

    [SetsRequiredMembers]
    public InspectionsAndCitationsLoader(IVendorAdapter vendorAdapter, BlobContainerClient containerClient, string environmentName, int maxDegreeOfParallelism, int maxRetries, int minRetryDelayMs) 
    ...
    {
        var endpoint = new InspectionsAndCitationsEndpoint(VendorAdapter, EnvironmentName, MaxDegreeOfParallelism, MaxRetries, MinRetryDelayMs);
        InitRun(endpoint);
