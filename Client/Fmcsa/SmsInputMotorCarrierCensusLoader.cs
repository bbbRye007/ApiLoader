...
public class SmsInputMotorCarrierCensusLoader: EndpointLoaderBase
{

    [SetsRequiredMembers]
    public SmsInputMotorCarrierCensusLoader(IVendorAdapter vendorAdapter, BlobContainerClient containerClient, string environmentName, int maxDegreeOfParallelism, int maxRetries, int minRetryDelayMs) 
    ...
    {
        var endpoint = new SmsInputMotorCarrierCensusEndpoint(VendorAdapter, EnvironmentName, MaxDegreeOfParallelism, MaxRetries, MinRetryDelayMs);
        InitRun(endpoint);
