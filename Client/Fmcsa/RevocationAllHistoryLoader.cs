...
public class RevocationAllHistoryLoader: EndpointLoaderBase
{

    [SetsRequiredMembers]
    public RevocationAllHistoryLoader(IVendorAdapter vendorAdapter, BlobContainerClient containerClient, string environmentName, int maxDegreeOfParallelism, int maxRetries, int minRetryDelayMs) 
    ...
    {
        var endpoint = new RevocationAllHistoryEndpoint(VendorAdapter, EnvironmentName, MaxDegreeOfParallelism, MaxRetries, MinRetryDelayMs);
        InitRun(endpoint);
