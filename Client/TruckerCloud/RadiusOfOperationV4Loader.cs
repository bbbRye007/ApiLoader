...
public class RadiusOfOperationMilesV4Loader: EndpointLoaderBase
{

    [SetsRequiredMembers]
    public RadiusOfOperationMilesV4Loader(IVendorAdapter vendorAdapter, BlobContainerClient containerClient, string environmentName, int maxDegreeOfParallelism, int maxRetries, int minRetryDelayMs) 
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var endpoint = new RadiusOfOperationMilesV4Endpoint(VendorAdapter, EnvironmentName, MaxDegreeOfParallelism, MaxRetries, MinRetryDelayMs);
        InitRun(endpoint);        
